...
export function ChangeThemeButton() {
    ...
    return (
        ...
        >
            <div
                className={`rounded-full absolute top-2/4  left-1 translate-y-[-50%] bg-gradient-to-br from-slate-400 to-slate-500 dark:from-slate-700 dark:to-slate-700 ${darkMode ? 'translate-x-[95%]' : 'translate-x-[-10%]'} grid transition-all duration-300 place-items-center w-6 h-6`}
            ></div>
            <FontAwesomeIcon
