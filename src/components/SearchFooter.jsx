export const SearchFooter = ({toggleSearch}) => {
    return (
        <div className='flex items-center bg-white dark:bg-slate-950 absolute bottom-0 right-0 text-[.7rem] font-medium text-slate-500 dark:text-slate-600 px-4 w-full h-14 border-t dark:border-slate-800'>
            ...
            <span onClick={toggleSearch} className='border lg:hidden mr-1 text-xs border-slate-400 dark:border-slate-700 dark:shadow-btn-d shadow-btn-l px-1 pb-[1px] rounded-[4px]'>
                close
            </span>
            ...
            <h1 className='ml-1 text-[16px]  font-title font-bold'>
                ...
                <a href="https://github.com/sh1baruuu" target="blank">shibaru</a>
            </h1>
        </div>
    );
};
